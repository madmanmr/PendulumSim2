...
Click link for demo which will take a year loading but means you dont run locally: [https://madmanmr.github.io/ ](https://github.com/madmanmr/PendulumSim2/releases/download/PendSIm2/main.zip)
Click this link for local demo: https://github.com/madmanmr/PendulumSim2/releases/latest/download/main.exe
Controls are:
  W = start simulation
